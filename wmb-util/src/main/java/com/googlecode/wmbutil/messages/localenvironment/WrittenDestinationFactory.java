...
import com.googlecode.wmbutil.messages.localenvironment.writtendestination.FileWrittenDestination;
...
public abstract class WrittenDestinationFactory<T extends MbElementWrapper> extends ImmutableElementWrapperFactory<T> {
  ...
  public static final WrittenDestinationFactory<FileWrittenDestination> FILE = new WrittenDestinationFactory<FileWrittenDestination>("FILE") {
    @Override protected FileWrittenDestination createWrapper(MbElement element) {
      return new FileWrittenDestination(element);
    }
  };
