...
import com.googlecode.wmbutil.messages.localenvironment.destination.FileDestination;
...
public abstract class DestinationFactory<T extends MbElementWrapper> extends MutableElementWrapperFactory<T> {
  ...
  public static final DestinationFactory<FileDestination> FILE = new DestinationFactory<FileDestination>("FILE") {
    @Override protected FileDestination createWrapper(MbElement element) {
      return new FileDestination(element);
    }
  };
