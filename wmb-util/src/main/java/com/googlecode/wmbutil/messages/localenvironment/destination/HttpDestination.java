...
public class HttpDestination extends MbElementWrapper {
    ...
    public void setRequestIdentifier(byte[] identifier) throws MbException {
        setValue(REQUEST_IDENTIFIER, identifier);
    }
    ...
    public byte[] getRequestIdentifer() throws MbException {
        return getValue(REQUEST_IDENTIFIER);
    }

    public String getRequestIdentiferAsString() throws MbException {
        return HexUtils.asHex(this.<byte[]>getValue(REQUEST_IDENTIFIER));
    }
}
